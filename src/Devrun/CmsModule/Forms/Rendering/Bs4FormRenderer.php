...
namespace Devrun\CmsModule\Forms\Rendering;
...
class Bs4FormRenderer extends DefaultFormRenderer
{
    ...
    public function __construct($layout = FormLayout::HORIZONTAL)
    {
        ...
        $this->wrappers['control']['container'] = $layout == FormLayout::HORIZONTAL ? 'div class=col-sm-10' : null;
        $this->wrappers['label']['container'] = $layout == FormLayout::HORIZONTAL ? 'div class="col-sm-2 col-form-label"' : null;
